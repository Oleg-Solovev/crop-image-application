...
// 2 вариант:
// vars
let result = document.querySelector('.result'), img_result = document.querySelector('.img-result'), img_w = document.querySelector('.img-w'), img_h = document.querySelector('.img-h'), options = document.querySelector('.options'), save = document.querySelector('.save'), cropped = document.querySelector('.cropped'), dwn = document.querySelector('.download'), upload = document.querySelector('#file-input'), cropper = '';
    ...
    if (e.target.files.length) {
        ...
        reader.onload = (e)=>{
            if (e.target.result) {
                ...
                // init cropper
                cropper = new (0, _cropperjsDefault.default)(img);
            }
        };
...
},{"cropperjs":"dBPeF","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dBPeF":[function(require,module,exports,__globalThis) {
/*!
 * Cropper.js v1.6.2
